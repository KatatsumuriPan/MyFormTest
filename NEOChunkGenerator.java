...
public class NEOChunkGenerator implements IChunkGenerator {
    ...
    private final NEO3DBiomeProvider biomeProvider = new NEO3DBiomeProvider(new Vec3i(NEOWorldProvider.WORLD_SIZE * 16, 256, NEOWorldProvider.WORLD_SIZE * 16), new Vec3i(20, 20, 20));
    ...
    private void placeBiomeBlocks(int chunkX, int chunkZ) {
        ...
        // var perlinNoise2 = new NoiseGeneratorOctaves(new Random(world.getSeed()), 8);
        double[] noise = perlinNoise.generateNoiseOctaves(null, chunkX * 16, 0, chunkZ * 16, 16, 256, 16, 10, 10, 10);
        // double[] noise2 = perlinNoise2.generateNoiseOctaves(null, chunkX * 16, 0, chunkZ * 16, 16, 256, 16, 400, 600, 400);
